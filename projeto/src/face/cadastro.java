...
public class cadastro extends javax.swing.JFrame {
    ...
    private void adicionar() {
        String sql = "insert into usuario(Nome, Login, Email, Senha, Telefone) values(?, ?, ?, ?,?)";
        try {
            ...
            if ((txtnome.getText().isEmpty()) || (txtlogin.getText().isEmpty()) || (txtemail.getText().isEmpty()) || (txtsenha.getText().isEmpty()) || (txttelefone.getText().isEmpty())) {
